...
const App = () => {
  ...
  const ai = new GoogleGenAI({ apiKey: "AIzaSyA6surxmnc4UyrGUowELxUU3QD95Rr57JM" }); // replace "YOUR_API_KEY" with you api key
...
⿡ A quality rating: Better, Good, Normal, or Bad.
⿢ Detailed suggestions for improvement, including best practices and advanced alternatives.
⿣ A clear explanation of what the code does, step by step.
⿤ A list of any potential bugs or logical errors, if found.
⿥ Identification of syntax errors or runtime errors, if present.
⿦ Solutions and recommendations on how to fix each identified issue.
